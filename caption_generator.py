...
def externel_caption_generate(image_name):
    ...
    modelvgg = load_model(r"C:\Users\YASWANTH\Downloads\project\project\model1.h5")
    model=VGG16()
    fe = Model(inputs=model.input, outputs=model.layers[-2].output)
    ext_feature = fe.predict(img, verbose=0)
    tokenizer=pickle.load(open(r"C:\Users\YASWANTH\Downloads\project\project\model1.h5","rb"))
    max_caption_len=34
